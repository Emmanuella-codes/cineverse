...
const Home: React.FC<Props> = () => {
  ...
  const { data: popularMovies } = useSWR('popularMovies', fetchers.fetchPopular)
  const { data: trendingNow } = useSWR('trendingNow', fetchers.fetchTrendingMovies)
  ...
  const { data: realitySeries } = useSWR('realitySeries', fetchers.fetchRealitySeries)
  const { data: romanceMovies } = useSWR('romanceMovies', fetchers.fetchRomance)
